...
This script reads the ellipsoid mesh, applies spherical conformal parametrization,
...
def main(mesh_path=None):
    """
    Main example: Load the ellipsoid mesh and apply spherical parametrization.
    """
    # Define path to ellipsoid mesh
    ...
    if not mesh_path.exists():
        ...
        print("Please ensure the data/ellipsoid.obj file exists in the repository.")
        return
...
if __name__ == "__main__":
    ...
    # input mesh
    parser = argparse.ArgumentParser(prog="sphepar_ellipsoid.py", description="Sphere parametrization example.")
    parser.add_argument("--mesh_path", type=str, default="../data/ellipsoid.obj", help="Path to the input mesh file (OBJ format).")
    args = parser.parse_args()

    main(mesh_path = args.mesh_path)
